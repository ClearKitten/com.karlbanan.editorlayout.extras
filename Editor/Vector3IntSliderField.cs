...
namespace KarlBanan.EditorLayout
{
    ...
    public class Vector3IntSliderField : VectorSliderField<Vector3Int>
    {
        ...
        protected override Vector3Int DrawComponentSlider(Rect sliderRect, Vector3Int currentValue, int index)
        {
            ...
            {
                case 0:
                    currentValue.x = EditorGUI.IntSlider(sliderRect, GUIContent.none, currentValue.x, minValue, maxValue);
                    break;
                case 1:
                    currentValue.y = EditorGUI.IntSlider(sliderRect, GUIContent.none, currentValue.y, minValue, maxValue);
                    break;
                case 2:
                    currentValue.z = EditorGUI.IntSlider(sliderRect, GUIContent.none, currentValue.z, minValue, maxValue);
                    break;
            }
            return currentValue;
        }
